...
func Int(value int) *int { return param.Int(value) }

func Int64(value int64) *int64 { return param.Int64(value) }

func Float64(value float64) *float64 { return param.Float64(value) }

func Bool(value bool) *bool { return param.Bool(value) }
