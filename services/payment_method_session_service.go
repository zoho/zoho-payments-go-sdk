...
func NewPaymentMethodSessionService(caller *internal.Caller, ed edition.Edition) *PaymentMethodSessionService {
	return &PaymentMethodSessionService{caller: caller, edition: ed}
}
